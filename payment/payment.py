...
img_label.image = logo
img_label.grid(row=0, column=0, columnspan=2, pady=10)
Label(formFrame, text="LessiDoidlam1\n", bg="white").grid(column=0, row=1, columnspan=2)

surname_label = Label(formFrame, text="Nom :", bg="white").grid(row=2, column=0, sticky=W, pady=5)
surname_entry = Entry(formFrame, width=30)
surname_entry.grid(row=2, column=1, pady=5)

name_label = Label(formFrame, text="Prénom :", bg="white").grid(row=3, column=0, sticky=W, pady=5)
name_entry = Entry(formFrame, width=30)
name_entry.grid(row=3, column=1, pady=5)

email_label = Label(formFrame, text="E-mail :", bg="white").grid(row=4, column=0, sticky=W, pady=5)
email_entry = Entry(formFrame, width=30)
email_entry.grid(row=4, column=1, pady=5)

wallet_adress_label = Label(formFrame, text="Adresse du portefeuille :", bg="white").grid(row=5, column=0, sticky=W, pady=5)
wallet_adress_entry = Entry(formFrame, width=30)
wallet_adress_entry.grid(row=5, column=1, pady=5)

amount_label = Label(formFrame, text="Montant :", bg="white").grid(row=6, column=0, sticky=W, pady=5)
...
img_label = Label(loadingFrame, image=logo, bg="white")
img_label.image = logo
